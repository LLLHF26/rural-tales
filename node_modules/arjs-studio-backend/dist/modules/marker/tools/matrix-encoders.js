...
exports.encode_5x5_bch_22_12_5 = exports.encode_5x5_bch_22_7_7 = exports.encode_4x4_bch_13_9_3 = exports.encode_4x4_bch_13_5_5 = exports.encode_3x3_parity_6_5 = exports.encode_3x3_hamming_6_3 = void 0;
/**
...
function polynomialDivide(lhs, rhs) {
    var rem = lhs, div = rhs;
    if (rhs === 0)
        throw new Error('divisor may not be zero');
...
function encode_3x3_hamming_6_3(n) {
    if (!Number.isInteger(n) || n < 0 || n >= 1 << 3)
        throw new Error("value invalid or out of range for 3x3_hamming_6_3: ".concat(n));
...
exports.encode_3x3_hamming_6_3 = encode_3x3_hamming_6_3;
/**
...
function encode_3x3_parity_6_5(n) {
    if (!Number.isInteger(n) || n < 0 || n >= 1 << 5)
        throw new Error("value invalid or out of range for 3x3_parity_6_5: ".concat(n));
...
exports.encode_3x3_parity_6_5 = encode_3x3_parity_6_5;
/**
...
function encode_bch(n, k, generator, data) {
    ...
    if (!Number.isInteger(data) || data < 0 || data >= 1 << k)
        throw new Error("value invalid or out of range for BCH with n = ".concat(n, ", k = ").concat(k, ": ").concat(data));
    // n is total number of bits per code word (i.e. number of data bits + number of error correction bits)
    if (n <= k)
        throw new Error("invalid BCH parameters: n = ".concat(n, ", k = ").concat(k));
    // generator polynomial has degree n-k, i.e. n-k+1 bits
    if (generator < (1 << (n - k) || generator >= 1 << (n - k + 1)))
        throw new Error("invalid generator polynomial for BCH with n = ".concat(n, ", k = ").concat(k, ": ").concat(generator));
    var ret = intToBitArray((data << (n - k)) ^ polynomialDivide(data << (n - k), generator).rem, n);
    if (ret.length < n)
        throw new Error('BCH calculation invalid');
    return ret;
}
/**
...
exports.encode_4x4_bch_13_5_5 = encode_4x4_bch_13_5_5;
/**
...
exports.encode_4x4_bch_13_9_3 = encode_4x4_bch_13_9_3;
/**
...
exports.encode_5x5_bch_22_7_7 = encode_5x5_bch_22_7_7;
/**
...
exports.encode_5x5_bch_22_12_5 = encode_5x5_bch_22_12_5;
//# sourceMappingURL=matrix-encoders.js.map